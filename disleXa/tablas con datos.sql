...
INSERT INTO `alumno_paciente` VALUES (1,6),(1,7),(1,8),(2,9),(2,10),(3,12);
...
CREATE TABLE `evaluacion_actividad` (
  ...
  CONSTRAINT `evaluacionActividad_evaluacion` FOREIGN KEY (`idEvaluacion`) REFERENCES `evaluacion` (`idEvaluacion`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuario` VALUES (4,'info@escuela7.com','123',NULL),(5,'info@escuelaCervantes.com','123',NULL),(6,'maxi@gmail.com','1234',NULL),(7,'julian@gmail.com','123',NULL),(8,'mariana.sanchez@gmail.com','123',NULL),(9,'mariana.sanchez@gmail.com','123',NULL),(10,'mariana.sanchez@gmail.com','123',NULL),(12,'celeste.ares@gmail.com','123',NULL);
...
-- Dump completed on 2017-07-08 15:09:43
