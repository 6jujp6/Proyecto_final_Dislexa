			...
			<div class="widget-wrapper">
				<div class="list-group">
					...
					<a href="#" class="list-group-item active">Bienvenido + Nombre
						Padre</a> <a href="javascript:void(0);"
						onclick="cargarActionContenido('responsable/datosPersonales', 'divContenidoResponsable');"
						class="list-group-item"><span class="glyphicon glyphicon-cog"></span>
						Datos personales</a> <a href="javascript:void(0);"
						onclick="cargarActionContenido('responsable/mensaje', 'divContenidoResponsable');"
		...
		<div class="col-lg-9">
			...
			<div class="row wow fadeIn" data-wow-delay="0.4s">
				<div class="col-lg-12">
					...
					<div id="divContenidoResponsable" class="jumbotron"></div>
				</div>
			</div>
			<!--/.First row-->
			<br>
